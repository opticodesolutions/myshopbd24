             ...
             <div class="ps-lg-10 mt-6 mt-md-0">
                ...
                <div class="fs-4">
                   <!-- price -->
                    ...
                    <span><small class="fs-6 ms-2 text-danger">{{ number_format($discountPercentage, 0) }}% Off</small></span>
                         ...
                         <div class="col-md-8">
                            <div class="mb-10">
                               ...
                               <div class="d-flex border-bottom pb-6 mb-6">
                                  <!-- img -->
                                  <!-- img -->
                                  <img src="{{ asset('frontend/assets/images/avatar/avatar-10.jpg')}}" alt="" class="rounded-circle avatar-lg" />
                                  <div class="ms-5">
                                     ...
                                     <div>
                                        <div class="border icon-shape icon-lg border-2">
                                           <!-- img -->
                                           <img src="{{ asset('frontend/assets/images/products/product-img-1.jpg')}}" alt="" class="img-fluid" />
                                        </div>
                                        <div class="border icon-shape icon-lg border-2 ms-1">
                                           <!-- img -->
                                           <img src="{{ asset('frontend/assets/images/products/product-img-2.jpg')}}" alt="" class="img-fluid" />
                                        </div>
                                        <div class="border icon-shape icon-lg border-2 ms-1">
                                           <!-- img -->
                                           <img src="{{ asset('frontend/assets/images/products/product-img-3.jpg')}}" alt="" class="img-fluid" />
                                        </div>
                                     </div>
                                     <!-- icon -->
                               ...
                               <div class="d-flex border-bottom pb-6 mb-6 pt-4">
                                  <!-- img -->
                                  <img src="{{ asset('frontend/assets/images/avatar/avatar-12.jpg')}}" alt="" class="rounded-circle avatar-lg" />
                                  <div class="ms-5">
                               ...
                               <div class="d-flex border-bottom pb-6 mb-6 pt-4">
                                  <!-- img -->
                                  <img src="{{ asset('frontend/assets/images/avatar/avatar-9.jpg')}}" alt="" class="rounded-circle avatar-lg" />
                                  <div class="ms-5">
                               ...
                               <div class="d-flex border-bottom pb-6 mb-6 pt-4">
                                  <!-- img -->
                                  <img src="{{ asset('frontend/assets/images/avatar/avatar-8.jpg')}}" alt="" class="rounded-circle avatar-lg" />
          ...
          <div class="col">
             <div class="card card-product">
                <div class="card-body">
                   <!-- badge -->
                   <div class="text-center position-relative">
                      <a href="#!"><img src="{{ asset('frontend/assets/images/products/product-img-2.jpg')}}" alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                      <!-- action btn -->
                      <div class="card-product-action">
                         <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal">
                            <i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" title="Quick View"></i>
          ...
          <div class="col">
             <div class="card card-product">
                <div class="card-body">
                   <!-- badge -->
                   <div class="text-center position-relative">
                      <a href="#!"><img src="{{ asset('frontend/assets/images/products/product-img-3.jpg')}}" alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                      <!-- action btn -->
                      <div class="card-product-action">
                         <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal">
                            <i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" title="Quick View"></i>
          ...
          <div class="col">
             <div class="card card-product">
                <div class="card-body">
                   <!-- badge -->
                   <div class="text-center position-relative">
                      <a href="#!"><img src="{{ asset('frontend/assets/images/products/product-img-4.jpg')}}" alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                      <!-- action btn -->
                      <div class="card-product-action">
                         <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal">
                            <i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" title="Quick View"></i>
          ...
          <div class="col">
             <div class="card card-product">
                <div class="card-body">
                   <!-- badge -->
                   <div class="text-center position-relative">
                      <a href="#!"><img src="{{ asset('frontend/assets/images/products/product-img-9.jpg')}}" alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                      <!-- action btn -->
                      <div class="card-product-action">
                         <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal">
                            <i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" title="Quick View"></i>
