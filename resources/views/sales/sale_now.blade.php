                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('sales.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('discount_price') is-invalid @enderror" name="discount_price" placeholder="Discount Price" value="{{ old('discount_price', $product->discount_price) }}" readonly>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('purchase_commission') is-invalid @enderror" name="purchase_commission" placeholder="Purchase Commission" value="{{ old('purchase_commission', $product->purchase_commission) }}" readonly>
...
value="{{ old('refer_code', $referCode) }}" 
/>                                    @error('refer_code')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
