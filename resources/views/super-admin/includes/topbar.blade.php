        ...
        <ul class="navbar-nav navbar-align">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="languageDropdown">
                    ...
                    <a class="dropdown-item" href="#">
                        <img src="{{ asset('backend/img/flags/es.png') }}" alt="Spanish" width="20" class="align-middle me-1" />
                        <span class="align-middle">Spanish</span>
                    </a>
                    <a class="dropdown-item" href="#">
                        <img src="{{ asset('backend/img/flags/ru.png') }}" alt="Russian" width="20" class="align-middle me-1" />
                        <span class="align-middle">Russian</span>
                    </a>
                    <a class="dropdown-item" href="#">
                        <img src="{{ asset('backend/img/flags/de.png') }}" alt="German" width="20" class="align-middle me-1" />
